...
public class Gui extends JFrame {
    ...
    private static int number_of_terms;
    ...
    private static JLabel status_bar = new JLabel();
    ...
    public void createGui() throws IOException {
        /*
         * create the menubar create file and help menues
         */
        ...
        fileOpen.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                ...
                if (returnVal == JFileChooser.APPROVE_OPTION) {
                    Gui.file = chooser.getSelectedFile();
                    Gui.setStatusBar(Gui.file.getAbsolutePath());
                }
            }
        });
         ...
         */
        ListModel terms_names_table_listModel = new AbstractListModel() {
            public int getSize() {
        ...
        TableModel terms_names_table_dataModel = y = new AbstractTableModel() {
        ...
        JList terms_names_rowHeader = new JList(terms_names_table_listModel);
        terms_names_rowHeader.setFixedCellWidth(50);
        terms_names_rowHeader
                .setFixedCellHeight(terms_names_table.getRowHeight() + terms_names_table.getRowMargin() - 1);
        ...
        TableModel main_table_dataModel = x = new AbstractTableModel() {
        ...
        /**
         * create buttons create status bar create text_area create spinner create radio
         * buttons
         */
        ...
        SpinnerModel smodel = new SpinnerNumberModel(number_of_terms, // initial value
                2, // min
                16, // max
                1);
        ...
        clear_button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                terms_names = Gui.default_terms_names;
                setAndClearValuesArray();
        ...
        main_panel.add(main_table_scroll, c);
        ...
        main_panel.add(terms_names_scroll, c1);
        ...
        main_panel.add(new JLabel("<html><font color=green>Number Of Terms</font></html>"), c3);
        ...
        main_panel.add(solve_button, c4);
        ...
        main_panel.add(clear_button, c5);
        ...
        c6.weighty = 0.5;
        c6.gridwidth = 3;
        main_panel.add(editor_pane_scroll, c6);
        ...
        main_panel.add(sum_of_products, c8);
        ...
        main_panel.add(product_of_sums, c9);
        ...
        main_panel.add(all_possible_sol, c10);
        ...
        main_panel.add(progress_bar, c12);
    }
